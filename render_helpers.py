...
def get_files(endpoint, api_token, node_name, datastore_id, insecure=False):
    return _g(endpoint, api_token, f'/nodes/{node_name}/storage/{datastore_id}/content', insecure)

def get_file(endpoint, api_token, node_name, datastore_id, file_id, insecure=False):
    encoded = urllib.parse.quote(file_id, safe='')
    return _g(endpoint, api_token, f'/nodes/{node_name}/storage/{datastore_id}/content/{encoded}', insecure)
...
def _sdn_get_subnet(endpoint, api_token, vnet, cidr, insecure=False):
    ...
    return _g(endpoint, api_token, f'/cluster/sdn/vnets/{vnet}/subnets/{encoded_cidr}', insecure)
...
def _sdn_fabric_node_get(endpoint, api_token, fabric_id, node_id, insecure=False):
    return _g(endpoint, api_token, f'/cluster/sdn/fabrics/{fabric_id}/nodes/{node_id}', insecure)
